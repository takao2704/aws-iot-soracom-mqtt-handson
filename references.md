...
[← 前へ：講師付録B：実機受入テスト](instructor/appendix-b-acceptance-test.md) | [目次](README.md#章一覧) | [READMEへ戻る →](README.md)
...
- [OASIS：MQTT Version 3.1.1仕様](https://docs.oasis-open.org/mqtt/mqtt/v3.1.1/mqtt-v3.1.1.html)
